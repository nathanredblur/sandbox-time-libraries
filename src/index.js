...
const parserMeta = {
  ...
  "Any-Date": {
    ...
    version: "2.2.3",
    desc: "Detección automática con parser.attempt(). ⚠️ Bug: la librería fue compilada con --platform=node y parser.attempt() devuelve resultados incorrectos para formatos MM/DD y DD/MM en algunos browsers (ej: Chrome).",
    chunk: "18.2 KB",
  },
  "Any-Date*": {
    ...
    url: "https://github.com/kensnyder/any-date-parser",
    version: "2.2.3",
    desc: "Parseo manual de formatos XX/XX/YYYY y XX-XX-YYYY para evitar bug cross-browser de la librería. Delega el resto a parser.attempt().",
    chunk: "18.2 KB",
    custom: true,
  },
  "Date-fns": {
